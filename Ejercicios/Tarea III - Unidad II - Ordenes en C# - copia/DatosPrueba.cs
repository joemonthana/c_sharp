...
public class DatosdePrueba
{
    ...
    {
        Producto p1 = new Producto(10000001, "Mouse", 250);
        ListadeProductos.Add(p1);

        Producto p2 = new Producto(10000002, "Teclado", 350);
        ListadeProductos.Add(p2);

        Producto p3 = new Producto(10000003, "Monitor", 4000);
        ListadeProductos.Add(p3);
    }

    private void cargarClientes()
    {
        Cliente c1 = new Cliente(90000001, "Fidelina Montana", "77777");
        ListadeClientes.Add(c1);

        Cliente c2 = new Cliente(90000002, "Esdras Perdomo", "99999");
        ListadeClientes.Add(c2);
    }

    private void cargarVendedores()
    {
        Vendedor v1 = new Vendedor(1, "Cesia Marisol", "V001");
        ListadeVendedores.Add(v1);

        Vendedor v2 = new Vendedor(2, "Mario Torres", "V002");
    ...
    public void CrearOrden()
    {
        ...
        Console.WriteLine("Impuesto sobre venta: " + nuevaOrden.Impuesto);
